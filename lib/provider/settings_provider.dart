...
final List<LLMProviderSetting> defaultApiSettings = [
  ...
  LLMProviderSetting(
    apiKey: '',
    apiEndpoint: 'https://api.z.ai/api/paas/v4',
    apiStyle: 'openai',
    providerId: 'glm',
    providerName: 'GLM',
    icon: 'glm',
...
class SettingsProvider extends ChangeNotifier {
  ...
  Future<List<LLMProviderSetting>> loadSettings() async {
    ...
    for (final defaultSetting in defaultApiSettings) {
      ...
      if (!existing.custom && defaultSetting.apiStyle != null && existing.apiStyle != defaultSetting.apiStyle) {
        existing.apiStyle = defaultSetting.apiStyle;
      }
    }
