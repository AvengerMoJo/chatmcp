  ...
  Future<String> _callLlm(String text) async {
    ...
    final response = await http.post(
      ...
      body: jsonEncode({
        'model': model,
        'messages': [
          {'role': 'system', 'content': 'You are a voice assistant. Keep responses under 50 words. Use natural spoken language. No markdown, no code blocks.'},
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Output
              Text('Output', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: Theme.of(context).colorScheme.primary)),
