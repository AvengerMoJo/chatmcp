...
class BufferedSummarySpeaker {
  ...
  BufferedSummarySpeaker({required this.ttsAdapter, this.minWords = 5, this.maxBufferWords = 100});
  ...
  void _speak(String text) {
    ...
    _log.info(
      'BufferedSpeaker speak (${cleaned.split(RegExp(r"\s+")).length}w): "${cleaned.length > 80 ? '${cleaned.substring(0, 80)}...' : cleaned}"',
    );
